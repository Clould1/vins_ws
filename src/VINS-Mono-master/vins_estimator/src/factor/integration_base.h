...
class IntegrationBase
{
  public:
                            ...
                            Eigen::Vector3d &result_linearized_ba, Eigen::Vector3d &result_linearized_bg, bool update_jacobian)
    {
        ...
        Vector3d un_acc = 0.5 * (un_acc_0 + un_acc_1);  //中值求加速度
        result_delta_p = delta_p + delta_v * _dt + 0.5 * un_acc * _dt * _dt; //x=v0t+1/2at^2
        result_delta_v = delta_v + un_acc * _dt;  //v=v0+at
